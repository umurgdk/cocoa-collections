...
public protocol OutlineViewBuilder {
    ...
    func makeTreeNodeRef(_ item: Item, isGroup: Bool, indexPath: IndexPath) -> OutlineTreeNodeRef
}
...
extension OutlineViewBuilder {
    public func makeTreeNodeRef(_ item: Item, isGroup: Bool, indexPath: IndexPath) -> OutlineTreeNodeRef {
        OutlineTreeNodeRef(item, isGroup: isGroup, viewBuilder: self, indexPath: indexPath)
    }
}
